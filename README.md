...
![Total](https://img.shields.io/badge/total-60-blue?style=flat-square) ![Active](https://img.shields.io/badge/active-59-brightgreen?style=flat-square) ![Slower](https://img.shields.io/badge/slower-1-orange?style=flat-square) ![Auto-update](https://img.shields.io/badge/auto--update-daily-lightgrey?style=flat-square)

> Last snapshot: 2026-03-11 05:17 UTC
...
[Developer Tools](#developer-tools) (8)<br>
[Other](#other) (1)<br>
...
|---|-----------|-------|----------|
| 1 | [awesome-selfhosted/awesome-selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) | ⭐ 279.3K | `—` |
| 2 | [massgravel/Microsoft-Activation-Scripts](https://github.com/massgravel/Microsoft-Activation-Scripts) | ⭐ 168.3K | `Batchfile` |
| 3 | [anomalyco/opencode](https://github.com/anomalyco/opencode) | ⭐ 119.9K | `TypeScript` |
| 4 | [rustdesk/rustdesk](https://github.com/rustdesk/rustdesk) | ⭐ 109.0K | `Rust` |
| 5 | [Comfy-Org/ComfyUI](https://github.com/Comfy-Org/ComfyUI) | ⭐ 105.5K | `Python` |

## Recently Starred (last 30 days)

1. **[Stremio/stremio-web](https://github.com/Stremio/stremio-web)** — Stremio - Freedom to Stream
2. **[rivenmedia/riven](https://github.com/rivenmedia/riven)** — Handle your Media Library with ease!
3. **[debridmediamanager/debrid-media-manager](https://github.com/debridmediamanager/debrid-media-manager)** — Curate an inifinite media library
4. **[AnalogJ/scrutiny](https://github.com/AnalogJ/scrutiny)** — Hard Drive S.M.A.R.T Monitoring, Historical Trends & Real World Failure Thresholds
5. **[Trooped/QuickBars](https://github.com/Trooped/QuickBars)** — The Official QuickBars for Home Assistant Repository
6. **[sirrobot01/decypharr](https://github.com/sirrobot01/decypharr)** — A Qbittorent Mock with Debrid Support
7. **[nicolargo/glances](https://github.com/nicolargo/glances)** — Glances an Eye on your system. A top/htop alternative for GNU/Linux, BSD, Mac OS and Windows...
8. **[linuxserver/Heimdall](https://github.com/linuxserver/Heimdall)** — An Application dashboard and launcher
9. **[dagster-io/dagster](https://github.com/dagster-io/dagster)** — An orchestration platform for the development, production, and observation of data assets.
...
- **[awesome-selfhosted/awesome-selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted)**
  ...
  <sub>Unknown | ★ 279.3K | pushed 2026-03-09 | fresh this week</sub>
...
- **[anomalyco/opencode](https://github.com/anomalyco/opencode)**
  ...
  <sub>TypeScript | ★ 119.9K | pushed 2026-03-11 | fresh this week</sub>
...
- **[Comfy-Org/ComfyUI](https://github.com/Comfy-Org/ComfyUI)**
  ...
  <sub>Python | ★ 105.5K | pushed 2026-03-11 | fresh this week</sub>

- **[davila7/claude-code-templates](https://github.com/davila7/claude-code-templates)**
  CLI tool for configuring and monitoring Claude Code<br>
  <sub>Python | ★ 22.7K | pushed 2026-03-11 | fresh this week</sub>
...
- **[nullclaw/nullclaw](https://github.com/nullclaw/nullclaw)**
  ...
  <sub>Zig | ★ 6.2K | pushed 2026-03-11 | fresh this week</sub>

- **[KeygraphHQ/shannon](https://github.com/KeygraphHQ/shannon)**
  Shannon Lite is a fully autonomous AI pentester for web apps and APIs. 96.15% (100/104 exploits) on a hint-free, source-aware variant of...<br>
  <sub>TypeScript | ★ 33.1K | pushed 2026-03-10 | fresh this week</sub>
...
- **[Maciek-roboblog/Claude-Code-Usage-Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor)**
  ...
  <sub>Python | ★ 6.9K | pushed 2025-09-14 | active</sub>
...
- **[HeyPuter/puter](https://github.com/HeyPuter/puter)**
  ...
  <sub>JavaScript | ★ 39.9K | pushed 2026-03-11 | fresh this week</sub>

- **[kimdre/doco-cd](https://github.com/kimdre/doco-cd)**
  Docker Compose Continuous Deployment<br>
  <sub>Go | ★ 1.2K | pushed 2026-03-11 | fresh this week</sub>

- **[ZoeyVid/NPMplus](https://github.com/ZoeyVid/NPMplus)**
  a fork of nginx-proxy-manager<br>
  <sub>TypeScript | ★ 1.9K | pushed 2026-03-11 | fresh this week</sub>

- **[coder/code-server](https://github.com/coder/code-server)**
  VS Code in the browser<br>
  <sub>TypeScript | ★ 76.6K | pushed 2026-03-11 | fresh this week</sub>
...
- **[hackthedev/dcts-shipping](https://github.com/hackthedev/dcts-shipping)**
  ...
  <sub>JavaScript | ★ 578 | pushed 2026-03-09 | fresh this week</sub>
...
- **[linkwarden/linkwarden](https://github.com/linkwarden/linkwarden)**
  ...
  <sub>TypeScript | ★ 17.5K | pushed 2026-03-06 | fresh this week</sub>
...
- **[sissbruecker/linkding](https://github.com/sissbruecker/linkding)**
  ...
  <sub>Python | ★ 10.3K | pushed 2026-03-04 | fresh this week</sub>
...
- **[maxdorninger/MediaManager](https://github.com/maxdorninger/MediaManager)**
  ...
  <sub>Python | ★ 3.1K | pushed 2026-03-04 | fresh this week</sub>
...
- **[louislam/dockge](https://github.com/louislam/dockge)**
  ...
  <sub>TypeScript | ★ 22.4K | pushed 2026-01-21 | active</sub>
...
- **[apache/airflow](https://github.com/apache/airflow)**
  ...
  <sub>Python | ★ 44.6K | pushed 2026-03-11 | fresh this week</sub>
...
- **[AnalogJ/scrutiny](https://github.com/AnalogJ/scrutiny)**
  ...
  <sub>Go | ★ 7.5K | pushed 2026-03-09 | fresh this week</sub>
...
- **[evilsocket/opensnitch](https://github.com/evilsocket/opensnitch)**
  ...
  <sub>Python | ★ 13.0K | pushed 2026-03-09 | fresh this week</sub>
...
- **[slskd/slskd](https://github.com/slskd/slskd)**
  ...
  <sub>C# | ★ 2.9K | pushed 2026-03-11 | fresh this week</sub>
...
- **[autobrr/qui](https://github.com/autobrr/qui)**
  ...
  <sub>Go | ★ 3.4K | pushed 2026-03-11 | fresh this week</sub>
...
- **[nicotine-plus/nicotine-plus](https://github.com/nicotine-plus/nicotine-plus)**
  ...
  <sub>Python | ★ 2.7K | pushed 2026-03-11 | fresh this week</sub>

- **[mpv-player/mpv](https://github.com/mpv-player/mpv)**
  🎥 Command line media player<br>
  <sub>C | ★ 34.4K | pushed 2026-03-10 | fresh this week</sub>
...
- **[ImranR98/Obtainium](https://github.com/ImranR98/Obtainium)**
  ...
  <sub>Dart | ★ 15.7K | pushed 2026-01-31 | active</sub>
...
- **[valinet/ExplorerPatcher](https://github.com/valinet/ExplorerPatcher)**
  ...
  <sub>C | ★ 31.8K | pushed 2025-11-03 | active</sub>

<h3 id="developer-tools">Developer Tools <sup>(8)</sup></h3>
...
- **[dbt-labs/dbt-core](https://github.com/dbt-labs/dbt-core)**
  ...
  <sub>Python | ★ 12.4K | pushed 2026-03-11 | fresh this week</sub>
...
- **[mountain-loop/yaak](https://github.com/mountain-loop/yaak)**
  ...
  <sub>TypeScript | ★ 18.1K | pushed 2026-03-11 | fresh this week</sub>
